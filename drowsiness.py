...
TWILIO_PHONE_NUMBER = "whatsapp:+141552388**"  # Twilio WhatsApp sandbox number
EMERGENCY_CONTACT = "whatsapp:+91983916****"  # Emergency contact WhatsApp number
    ...
    for face in faces:
        ...
        if EAR < DROWSINESS_THRESHOLD:
            ...
            if elapsed_time >= ALERT_DURATION and not emergency_alert_sent:
                print("Sending emergency WhatsApp message...")
                try:
                    message = client.messages.create(
                        body="Emergency! Drowsiness detected for too long. Please check on the driver.",
